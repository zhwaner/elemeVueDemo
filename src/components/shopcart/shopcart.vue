	...
	<div>
		<div class="shopcart">
			<div class="content" @click="toggleList">
				<div class="content-left">
					<div class="logo-wrapper">
						<div class="logo" :class="{'highlight': totalCount>0}">
							<div class="icon-shopping_cart" :class="{'highlight': totalCount}"></div>
						</div>
				...
				<div class="content-right" @click.stop.prevert="pay">
		...
		computed: {
			...
			listShow() {
				...
				if(show) {
					this.$nextTick(() => {
						if(!this.scroll) {
							this.scroll = new JRoll(this.$refs.foodListWrapper, {});
						}else {
							this.scroll.refresh();
						}
					});
